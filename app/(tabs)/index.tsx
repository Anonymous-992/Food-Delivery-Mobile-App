      ...
      <FlatList
        ...
        ListHeaderComponent={() => {
          ...
          return (
            <View>
              <View className="mb-2">
                <Text className="text-dark-100 text-2xl font-quicksand-bold">Hello, {user?.name?.split(' ')[0] || 'User'} 👋</Text>
              </View>
              <View className="flex-between flex-row w-full mb-5">
                <View className="flex-start">
                  <Text className="small-bold text-primary">DELIVER TO</Text>
                  <TouchableOpacity className="flex-center flex-row gap-x-1 mt-0.5">
                    <Text className="paragraph-bold text-dark-100">{user?.address1 || 'Add Address'}</Text>
